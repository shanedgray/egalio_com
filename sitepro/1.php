...
<head>
	...
	<style type="text/css">
		body { background: #ffffff none repeat-x scroll center top; }
		...
		#wb_element_instance0 ul { background: transparent none repeat scroll left top; border: 0px none #000000; text-align: left; }
		...
		#wb_element_instance0 li a { text-transform: none; border: 0px none #000000; padding: 2px 2px 2px 2px; font: normal normal 22px Arial,Helvetica,sans-serif; text-decoration: none; color: #2c2c2c; line-height: 24px; background: transparent none repeat scroll left top; }
		#wb_element_instance0 li:hover > a, #wb_element_instance0 li:focus > a { border: 0px none #000000; font: normal normal 22px Arial,Helvetica,sans-serif; text-decoration: none; color: #43852d; line-height: 24px; background: transparent none repeat scroll left top; }
		#wb_element_instance0 li.active > a { border: 0px none #000000; font: normal normal 22px Arial,Helvetica,sans-serif; text-decoration: none; color: #43852d; line-height: 24px; background: transparent none repeat scroll left top; }
	</style>
...
<body>{{ga_code}}<div class="root" style="width: 1003px; height: 731px;"><div class="vbox wb_container" id="wb_header" style="height: 511px; background: transparent none repeat scroll left top;">
	
<div id="wb_element_instance1" class="wb_element" style="left: 310px; top: 110px; width: 380px; height: 380px; min-width: 380px; min-height: 380px; z-index: 58;"><img alt="" src="gallery/b2018b0894e5272bbd07111ea4454d05_380x380.png" style="width: 380px; height: 380px;"></div></div>
<div class="vbox wb_container" id="wb_main" style="height: 70px; background: transparent none repeat scroll left top; padding: 0 0 50px 0;">
	
<div id="wb_element_instance2" class="wb_element" style="left: 520px; top: 40px; width: 30px; height: 30px; min-width: 30px; min-height: 30px; z-index: 59;"><a href="http://twitter.com/egaliohq" target="1"><img alt="Egalio HQ" src="gallery/26f50ce92b7e63ea6050a3fbedead192_30x30.png" style="width: 30px; height: 30px;"></a></div><div id="wb_element_instance3" class="wb_element" style="left: 450px; top: 40px; width: 30px; height: 30px; min-width: 30px; min-height: 30px; z-index: 61;"><a href="http://blog.egalio.com" title="Egalio's Blog" target="1"><img alt="Egalio's Blog" src="gallery/a90f95c66684353db1403def18ca362d_30x30.png" style="width: 30px; height: 30px;"></a></div><div id="wb_element_instance6" class="wb_element" style="left: 0px; top: 90px; min-width: 0px; min-height: 0px; z-index: 9000; width: 100%;">
			<?php
...
<div class="vbox wb_container" id="wb_footer" style="height: 180px; background: transparent none repeat scroll center bottom;">
	
<div id="wb_element_instance0" class="wb_element" style="left: 710px; top: 20px; width: 280px; height: 57px; min-width: 280px; min-height: 57px; z-index: 39;"><ul class="hmenu"></ul></div><div id="wb_element_instance4" class="wb_element" style="left: 240px; top: 30px; width: 510px; height: 27px; min-width: 510px; min-height: 27px; z-index: 40;  line-height: normal;"><p class="wb-stl-normal" style="text-align: center;"><font color="#000000" size="3"><span style="line-height: 24px;">Egalio Ltd Registered in Ireland</span></font></p>
</div><div id="wb_element_instance5" class="wb_element" style="left: 76px; top: 0px; width: 200px; height: 100px; min-width: 200px; min-height: 100px; z-index: 41; overflow: hidden;"><script>
  (function(i,s,o,g,r,a,m){i['GoogleAnalyticsObject']=r;i[r]=i[r]||function(){
  (i[r].q=i[r].q||[]).push(arguments)},i[r].l=1*new Date();a=s.createElement(o),
  m=s.getElementsByTagName(o)[0];a.async=1;a.src=g;m.parentNode.insertBefore(a,m)
  })(window,document,'script','//www.google-analytics.com/analytics.js','ga');

  ga('create', 'UA-52836717-1', 'auto');
  ga('send', 'pageview');

</script></div><div id="wb_element_instance7" class="wb_element" style="left: 0px; top: 120px; min-width: 0px; min-height: 0px; z-index: 9999; text-align: center; width: 100%;"><div class="wb_footer"></div><script type="text/javascript">
			$(function() {
