...
<head>
	...
	<style type="text/css">
		...
		#wb_element_instance8 ul { background: transparent none repeat scroll left top; border: 0px none #000000; text-align: left; }
		#wb_element_instance8 ul ul { background: #2e2e2e none repeat scroll left top; }
		#wb_element_instance8 li { margin: 10px 10px 10px 10px; }
		#wb_element_instance8 li a { text-transform: none; border: 0px none #000000; padding: 2px 2px 2px 2px; font: normal normal 22px Arial,Helvetica,sans-serif; text-decoration: none; color: #2c2c2c; line-height: 24px; background: transparent none repeat scroll left top; }
		#wb_element_instance8 li:hover > a, #wb_element_instance8 li:focus > a { border: 0px none #000000; font: normal normal 22px Arial,Helvetica,sans-serif; text-decoration: none; color: #43852d; line-height: 24px; background: transparent none repeat scroll left top; }
		#wb_element_instance8 li.active > a { border: 0px none #000000; font: normal normal 22px Arial,Helvetica,sans-serif; text-decoration: none; color: #43852d; line-height: 24px; background: transparent none repeat scroll left top; }
	</style>
...
<div id="wb_element_instance8" class="wb_element" style="left: 710px; top: 20px; width: 280px; height: 57px; min-width: 280px; min-height: 57px; z-index: 39;"><ul class="hmenu"></ul></div><div id="wb_element_instance9" class="wb_element" style="left: 0px; top: 97px; min-width: 0px; min-height: 0px; z-index: 9000; width: 100%;">
			<?php
			...
			?>
			</div><div id="wb_element_instance10" class="wb_element" style="left: 0px; top: 117px; min-width: 0px; min-height: 0px; z-index: 9999; text-align: center; width: 100%;"><div class="wb_footer"></div><script type="text/javascript">
			$(function() {
